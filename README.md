# IT23758094 – IT3040 Assignment 1

##  Project Title
Automated Testing for Singlish to Sinhala Transliteration System

##  Repository
https://github.com/Gunawardhana2000/IT23758094
...
- IT23758094_Test cases.xlsx → Excel file with test cases & results  
- IT23758094_requirements.txt             → Python dependencies  
...
4. Run the automation script  
  python test_automation.py --excel "IT23758094_Test cases.xlsx" --url "https://www.pixelssuite.com/chat-translator" --wait-ms 6000 --retry-wait-ms 1500 --retries 10 --type-delay-ms 60 --slow-mo-ms 300 --timeout-ms 60000 --save-every 1 --keep-open
